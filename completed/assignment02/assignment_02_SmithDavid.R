...
person_df1 <- read.csv("F:/GitLab-Projects/Bellevue/smith-dsc520/data/tidynomicon/person.csv")
str(person_df1)
...
person_df2 <- read.csv("F:/GitLab-Projects/Bellevue/smith-dsc520/data/tidynomicon/person.csv", stringsAsFactors=FALSE)
str(person_df2)

## Read the file `data/scores.csv` to `scores_df`
## Display summary statistics using the `summary()` function
scores_df <- read.csv("F:/GitLab-Projects/Bellevue/smith-dsc520/data/scores.csv")
summary(scores_df)
...
voter_turnout_df <- excel_sheets("F:/GitLab-Projects/Bellevue/smith-dsc520/data/G04ResultsDetail2004-11-02.xls")
voter_turnout_df
...
voter_turnout_df1 <- read_excel("F:/GitLab-Projects/Bellevue/smith-dsc520/data/G04ResultsDetail2004-11-02.xls")
...
voter_turnout_df2 <- read_excel("F:/GitLab-Projects/Bellevue/smith-dsc520/data/G04ResultsDetail2004-11-02.xls",skip=2)
